export const SOURCES = Object.freeze({
  ...
  ANALYTICS_CONTENT: "cw-business-analytics-content",
  OPTIONS: "cw-options",
  ANALYTICS_PAGE: "cw-business-analytics-page"
});
...
export const MESSAGE_TYPES = Object.freeze({
  ...
  ANALYTICS_GET_LATEST: "CW_ANALYTICS_GET_LATEST",
  ANALYTICS_SAVE_COMPLETE: "CW_ANALYTICS_SAVE_COMPLETE",
  ANALYTICS_SAVE_QUERY_CACHE: "CW_ANALYTICS_SAVE_QUERY_CACHE",
  ANALYTICS_GET_FAILED: "CW_ANALYTICS_GET_FAILED",
  ANALYTICS_SAVE_FAILED: "CW_ANALYTICS_SAVE_FAILED",
  ANALYTICS_CLEANUP: "CW_ANALYTICS_CLEANUP",
  ANALYTICS_CLEAR_CACHE: "CW_ANALYTICS_CLEAR_CACHE",
  ANALYTICS_CLEAR_HISTORY: "CW_ANALYTICS_CLEAR_HISTORY",
  ANALYTICS_STATS: "CW_ANALYTICS_STATS",
  ANALYTICS_REQUEST: "CW_ANALYTICS_REQUEST",
  ANALYTICS_PROGRESS: "CW_ANALYTICS_PROGRESS",
  ANALYTICS_RESULT: "CW_ANALYTICS_RESULT",
  ANALYTICS_ERROR: "CW_ANALYTICS_ERROR",
  ANALYTICS_CANCEL: "CW_ANALYTICS_CANCEL"
});
...
const REQUEST_ID_TYPES = new Set([
  ...
  MESSAGE_TYPES.ANALYTICS_GET_LATEST,
  MESSAGE_TYPES.ANALYTICS_SAVE_COMPLETE,
  MESSAGE_TYPES.ANALYTICS_SAVE_QUERY_CACHE,
  MESSAGE_TYPES.ANALYTICS_GET_FAILED,
  MESSAGE_TYPES.ANALYTICS_SAVE_FAILED,
  MESSAGE_TYPES.ANALYTICS_CLEANUP,
  MESSAGE_TYPES.ANALYTICS_CLEAR_CACHE,
  MESSAGE_TYPES.ANALYTICS_CLEAR_HISTORY,
  MESSAGE_TYPES.ANALYTICS_STATS,
  MESSAGE_TYPES.ANALYTICS_REQUEST,
