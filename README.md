...
截至 2026-07-19，构建、204 个 Node 单元/集成测试和 9 个离线 Chromium E2E 已通过。E2E 覆盖原三类自动化、Options、项目菜单、面板实时初始化、默认投入范围、工作集复用、空值、合同金额兜底、上期比较、分页、全部部门、内存重试、取消、会话失效、HTML 下载和无经营 IndexedDB，并断言不请求真实 `jxmis.cyberwing.cn`。
