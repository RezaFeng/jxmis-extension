(function (root, factory) {
  ...
  return {
    ...
    addDays: addDays,
    mondayOf: mondayOf,
    normalizeWeekRange: normalizeWeekRange,
    readControlValue: readControlValue,
    parseWkIdFromLocation: parseWkIdFromLocation,
    fetchWeeklyById: fetchWeeklyById,
    fetchWeeklyRowsByProject: fetchWeeklyRowsByProject,
    selectWeeklyRow: selectWeeklyRow,
    getWeeklyContext: getWeeklyContext
  };
});
